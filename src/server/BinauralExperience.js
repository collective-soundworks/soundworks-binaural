...
export default class SoundfieldExperience extends Experience {
  ...
  enter(client) {
    ...
    this.receive(client, 'play', () => {
      console.log('rcv play msg from:', client.coordinates)
      this.broadcast('player', client, 'play', client.coordinates);
    });
  }
  ...
  /**
   * This method is called whenever a `soloists` client send the coordinates of
